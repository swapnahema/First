...
def updatesub(request, id):
  ...
  mymember.BloodGroup=request.POST["BloodGroup"]
  mymember.Class=request.POST["Class"]
  mymember.save()
...
def createsub(request):
  ...
  mymember = Student(rollnumber=rollnumber,name=name,BloodGroup=BloodGroup,Class=Class)
  mymember.save()
  response = redirect('/students')
  return response
